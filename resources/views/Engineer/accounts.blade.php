                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                                ...
                                <span><b>Juliamar</b>Soriano<i class=" icofont icofont-simple-down"></i></span>

                            </a>
                            <ul class="dropdown-menu settings-menu">
                                <li><a href="#!"><i class="icon-settings"></i> Settings</a></li>
                                <li><a href="profile"><i class="icon-user"></i> Profile</a></li>
                                <li><a href="message"><i class="icon-envelope-open"></i> My Messages</a></li>
                                <li class="p-0">
                                    <div class="dropdown-divider m-0"></div>
                                </li>
                                <li><a href="lock-screen"><i class="icon-lock"></i> Lock Screen</a></li>
                                <li><a href="../login"><i class="icon-logout"></i> Logout</a></li>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="projectprogress">
                            <i class="icon-chart"></i><span> Project Progress</span>
                        </a>                
                    </li>
                    ...
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="inbox">
                            <i class="icon-envelope-letter"></i><span> Inbox</span>
                        </a>                
                    </li>
                    
                      <li class="active treeview">
                        <a class="waves-effect waves-dark" href="accounts">
                            <i class="icon-people"></i><span> Accounts</span>
                        </a>                
                    </li>
                    ...
                    <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> UI Elements</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            <li><a class="waves-effect waves-dark" href="accordion"><i class="icon-arrow-right"></i> Accordion</a></li>
                            <li><a class="waves-effect waves-dark" href="button"><i class="icon-arrow-right"></i> Button</a></li>
                            <li><a class="waves-effect waves-dark" href="label-badge"><i class="icon-arrow-right"></i> Label Badge</a></li>
                            <li><a class="waves-effect waves-dark" href="bootstrap-ui"><i class="icon-arrow-right"></i> Grid system</a></li>
                            <li><a class="waves-effect waves-dark" href="box-shadow"><i class="icon-arrow-right"></i> Box Shadow</a></li>
                            <li><a class="waves-effect waves-dark" href="color"><i class="icon-arrow-right"></i> Color</a></li>
                            <li><a class="waves-effect waves-dark" href="light-box"><i class="icon-arrow-right"></i> Light Box</a></li>
                            <li><a class="waves-effect waves-dark" href="notification"><i class="icon-arrow-right"></i> Notification</a></li>
                            <li><a class="waves-effect waves-dark" href="panels-wells"><i class="icon-arrow-right"></i> Panels-Wells</a></li>
                            <li><a class="waves-effect waves-dark" href="tabs"><i class="icon-arrow-right"></i> Tabs</a></li>
                            <li><a class="waves-effect waves-dark" href="tooltips"><i class="icon-arrow-right"></i> Tooltips</a></li>
                            <li><a class="waves-effect waves-dark" href="typography"><i class="icon-arrow-right"></i> Typography</a></li>
                        </ul>
                    </li>

                    <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Charts &amp; Maps</span><span class="label label-danger menu-caption">New</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            <li><a class="waves-effect waves-dark" href="float-chart"><i class="icon-arrow-right"></i> Float Charts</a></li>
                            <li><a class="waves-effect waves-dark" href="morris-chart"><i class="icon-arrow-right"></i> Morris Charts</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span> Forms</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            <li><a class="waves-effect waves-dark" href="form-elements-bootstrap"><i class="icon-arrow-right"></i> Form Elements Bootstrap</a></li>
                            <li><a class="waves-effect waves-dark" href="form-elements-materialize"><i class="icon-arrow-right"></i> Form Elements Material</a></li>
                            <li><a class="waves-effect waves-dark" href="form-elements-advance"><i class="icon-arrow-right"></i> Form Elements Advance</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-docs"></i><span>Pages</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            <li class="treeview"><a href="#!"><i class="icon-arrow-right"></i><span> Authentication</span><i class="icon-arrow-down"></i></a>
                                <ul class="treeview-menu">
                                    <li><a class="waves-effect waves-dark" href="register1" target="_blank"><i class="icon-arrow-right"></i> Register 1</a></li>
                                    
                                    <li><a class="waves-effect waves-dark" href="../login" target="_blank"><i class="icon-arrow-right"></i><span> Login 1</span></a></li>
                                    <li><a class="waves-effect waves-dark" href="forgot-password" target="_blank"><i class="icon-arrow-right"></i><span> Forgot Password</span></a></li>
                                    <li><a class="waves-effect waves-dark" href="profile"><i class="icon-arrow-right"></i> Profile</a></li>
                                </ul>
                            </li>
                            <li><a class="waves-effect waves-dark" href="lock-screen" target="_blank"><i class="icon-arrow-right"></i> Lock Screen</a></li>
                            <li><a class="waves-effect waves-dark" href="404" target="_blank"><i class="icon-arrow-right"></i> Error 404</a></li>
                            <li><a class="waves-effect waves-dark" href="sample-page"><i class="icon-arrow-right"></i> Sample Page</a></li>
                            <li><a class="waves-effect waves-dark" href="search-result"><i class="icon-arrow-right"></i> Search Result</a></li>
                        </ul>
                    </li>
...
<!-- Sidebar chat end-->
            ...
            <div class="row" style="margin-top: -10px">
                <div class="col-sm-9 p-0">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        <li class="breadcrumb-item"><a href="index"><i class="icon-people"></i></a>
                        </li>
                        <li class="breadcrumb-item"><a href="#!">Users</a>
                        </li>
                        <li class="breadcrumb-item"> <span class="label label-info"><b>Users Table</b>
                        </li>
                    </ol>
    ...
    <label class="text text-muted"> Users</label> 
                ...
                <div class="col-sm-3 pull-right">
                    <br> <br> <button type="button" data-toggle="modal" data-target="#addUser" class="btn btn-success waves-effect waves-light" style="margin-left: 45px"> <i class="icon-user-follow"> </i>Add User</button>
                    </div> 
                                ...
                                <div class="col-sm-12 table-responsive"> 
                                    <table class="table table-hover"  >
                                        ...
                                        <tr>
                                            ...
                                            <th><span class="text text-danger">User Type</span></th>
                                            <th></th>
                                            <th></th>
                                        ...
                                        <tr class="table-warning">
                                          ...
                                          <td>  <a href="profile" class="btn btn-warning label label-warning" role="button"> View </a> </td>
                                          <td> <button data-toggle="modal" data-target="#deactivateUser" class="btn label label-danger">Deactivate</button> </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content pull-center">
      <div class="modal-header color color-info">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="label label-info">Add User Account</span></h4>
      </div>
...
<div class="form-group">
    ...
    <div class="modal-footer">
        <hr>
         <button type="submit" class="btn btn-success" data-dismiss="modal"><i class="icon icon-check"> </i>Add User</button>
...
<!--[if lt IE 9]>
      ...
      <!-- custom js -->
      <script type="text/javascript" src="../assets/js/main.min.js"></script> <!-- welcome admin able -->
