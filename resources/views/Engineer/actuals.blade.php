        ...
        <aside class="main-sidebar hidden-print " >
            <section class="sidebar" id="sidebar-scroll">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> Cost</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a class="waves-effect waves-dark" href="actuals"><i class="icon-arrow-right"></i> Actuals</a></li>
                        </ul>
                    </li>
                    ...
                    <li class=" treeview">
                        <a class="waves-effect waves-dark" href="materials%20pricelist">
                            <i class="icon-notebook"></i><span> Materials PriceList</span>
                        </a>                
                    </li>
...
<!--tabs-->
  ...
  <ul class="nav nav-tabs" style="background-color: #f2f2f2"> 
    ...
    <li><a href="index">Dashboard</a></li>
      ...
      <li><a href="materials%20pricelist">PriceList</a></li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content pull-center">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><span class="label label-info">Actuals Entry</span></h4>
      </div>
      <div class="modal-body" style="background: #e5e5f2 !important; ">
...
<option value="2018" selected >2018</option>
         ...
         <button type="submit" class="btn btn-success" data-dismiss="modal"><i class="icon icon-check"> </i>Add Entry</button>
        <button type="button" class="btn btn-warning" data-dismiss="modal" style="margin-left: 280px"><i class="icon icon-close" > </i>Cancel</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content pull-center">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><span class="label label-info">Update Entry</span></h4>
      </div>
      <div class="modal-body" style="background: #e5e5f2 !important; ">
...
<option value="2018" selected >2018</option>
         ...
         <button type="submit" class="btn btn-success" data-dismiss="modal"><i class="icon icon-check"> </i>Update Entry</button>
        <button type="button" class="btn btn-warning" data-dismiss="modal" style="margin-left: 280px"><i class="icon icon-close" > </i>Cancel</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content pull-center">
      <div class="modal-header bg-primary" >
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><span style="color: white"><b>Audit Trail</b></span></h4>
      </div>
      <div class="modal-body" style="background: #e5e5f2 !important; ">
            ...
            <div class="row" style="margin-top: -10px">
                <div class="col-sm-9 p-0">
                    <div class="main-header" >
                       <h4><i class="icon icon-note"></i> Actuals</h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        <li class="breadcrumb-item"><a href="index"></a>
                        </li>
                        <li class="breadcrumb-item"><a href="#!">Actuals List</a>
                        </li>
                                ...
                                <div class="col-sm-12 table-responsive"> 
                                    <table class="table table-hover "  >
                                        ...
                                        <tr class="table-warning">
                                            <td>1</td>
                                            <td>Cement
                                            <p><i class="icofont icofont-clock-time"></i>Updated</p></td>
                                            <td>100.00</td>
                                            <td>1</td>
                                            <td>bag</td>
                                            ...
                                            <td> <button data-toggle="modal" data-target="#viewAudit" class="btn label label-light "> <span style="color: dimgray">Audit Trail</span></button>
                                            </td>
                                        </tr>
