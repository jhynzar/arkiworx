        ...
        <div class="row ">
          ...
          <div class="col-sm-6 col-xs-12"> <br> 
                    <div class="card" style="background-color: #A7FDCB">
                        ...
                        <div class="form-group pull-center">
                                <label for="">Cement Class Mixture:</label>
                                <select class="form-control" id="WallFootingCC" style="width: 160px !important;">
                                    <option value="1">Class AA </option>
                                     <option value="2" >Class A </option>
                                    <option value="3" selected>Class B </option>
                                    <option value="4" >Class C </option>
...
<script>
    ...
    $("#Beam").click(function(){
        ...
        var metalica = function(noofbars,spacing){
            //
            var tiebar = Math.ceil( ( (Math.ceil(parseFloat($("#BeamThickness").val()) / spacing) + 1) * (( parseFloat($("#BeamWidth").val()) * 2 ) + ( parseFloat($("#BeamLength").val()) * 2  )) ) / 6);
            var tiewire = (((Math.ceil(parseFloat($("#BeamThickness").val()) / spacing) + 1)*noofbars) * 0.4)/53 ;
            var metals1 = DirectCountingEsti(noofbars,4);
            var cost1 = metals1.total;
            var metals2 = DirectCountingEsti(tiebar,5);
            var cost2 = metals2.total;
        ...
        if(parseFloat($("#BeamThickness").val())<=0||parseFloat($("#BeamWidth").val())<=0||parseFloat($("#BeamLength").val())<=0||parseFloat($("#ColumnSpacing").val())<=0){
            alert("Invalid Input.");
        }
        else if(parseFloat($("#BeamThickness").val())==null&&parseFloat($("#BeamWidth").val())==null&&parseFloat($("#BeamLength").val())==null||parseFloat($("#ColumnSpacing").val())== null){
            var concrete = ConcreteEsti( 1,1.6,1,parseFloat($("#BeamCC").val()),1 );
            var metal = metalica(4,0.5);
            panapos(concrete.cementqty,concrete.cementcost,concrete.gravelqty,concrete.gravelcost,concrete.sandqty,concrete.sandcost,4,metal.tiebar,metal.tiewire,metal.costa,metal.costb,metal.costc);
        }
        else if(parseFloat($("#BeamThickness").val())!=null&&parseFloat($("#BeamWidth").val())!=null&&parseFloat($("#BeamLength").val())!=null&&parseFloat($("#ColumnSpacing").val())!=null){
            $("#BeamVolume").val( parseFloat($("#BeamThickness").val()) * parseFloat($("#BeamWidth").val()) * parseFloat($("#BeamLength").val()) );
            var concrete = ConcreteEsti( 1,parseFloat($("#BeamVolume").val()),1,parseFloat($("#BeamCC").val()),1 );
            var metal = metalica(parseFloat($("#BeamNoOfBars").val()),parseFloat($("#BeamSpacing").val()));
            panapos(concrete.cementqty,concrete.cementcost,concrete.gravelqty,concrete.gravelcost,concrete.sandqty,concrete.sandcost,parseFloat($("#BeamNoOfBars").val()),metal.tiebar,metal.tiewire,metal.costa,metal.costb,metal.costc);
    ...
    $("#WallFooting").click(function(){
        ...
        var metalica = function(){
            var mainbar = Math.ceil((parseFloat($("#WallFootingWidth").val()) - 0.15) * (parseFloat($("#WallFootingNoOfBars").val())*2)/6) ;
            var tiewire = ((parseFloat($("#WallFootingNoOfBars").val()) * parseFloat($("#WallFootingNoOfBars").val()))*0.4)/53;
            var metals1 = DirectCountingEsti(mainbar,4);
            var cost1 = metals1.total;
            var metals2 = DirectCountingEsti(tiewire,6);
            var cost2 = metals2.total;
        ...
        if(parseFloat($("#WallFootingThickness").val())<=0||parseFloat($("#WallFootingWidth").val())<=0||parseFloat($("#WallFootingLength").val())<=0||parseFloat($("#WallFootingNoOfBars").val())<=0){
            alert("Invalid Input.");
        }
        else if(parseFloat($("#WallFootingThickness").val())==null&&parseFloat($("#WallFootingWidth").val())==null&&parseFloat($("#WallFootingLength").val())==null||parseFloat($("#WallFootingNoOfBars").val())==null){
            var concrete = ConcreteEsti( 1,0.8,1,parseFloat($("#WallFootingCC").val()),1 );
            var metal = metalica(  );
            panapos(concrete.cementqty,concrete.cementcost,concrete.gravelqty,concrete.gravelcost,concrete.sandqty,concrete.sandcost);
        }
        else if(parseFloat($("#WallFootingThickness").val())!=null&&parseFloat($("#WallFootingWidth").val())!=null&&parseFloat($("#WallFootingLength").val())!=null||parseFloat($("#WallFootingNoOfBars").val())!=null){
            $("#WallFootingVolume").val( parseFloat($("#WallFootingThickness").val()) * parseFloat($("#WallFootingWidth").val()) * parseFloat($("#WallFootingLength").val()) );
            var concrete = ConcreteEsti( 1,parseFloat($("#WallFootingVolume").val()),1,parseFloat($("#WallFootingCC").val()),1 );
            var metal = metalica(  );
