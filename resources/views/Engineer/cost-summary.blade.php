                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> Cost</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            <li  class="active" ><a class="waves-effect waves-dark" href="cost%20summary"><i class="icon-arrow-right"></i> Cost Summary</a></li>
            ...
            <div class="row" style="margin-top: -10px">
                <div class="col-sm-9 p-0">
                    <div class="main-header" >
                       <h4><i class="icon icon-briefcase"></i> Cost </h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        <li class="breadcrumb-item"><a href="index"></a>
                        </li>
                        <li class="breadcrumb-item"><a href="#!" >Cost Summary</a>
                        </li>
          ...
          <option selected > Javier Residence </option>
              ...
              <br>          
                ...
                <div class="col-sm-3 pull-right">
                    <br> <br> <button type="button" data-toggle="modal" data-target="#showReports" class="btn btn-success waves-effect waves-light" style="margin-left: -20px; margin-top: 20px"> <i class="icon-list"> </i>Show Reports</button>
                    </div> 
