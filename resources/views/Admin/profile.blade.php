...
<head>
 ...
 <body class="sidebar-mini fixed">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <!-- Navbar-->
            ...
            <a href="Admin/home" class="nav-brand"><img class="img-fluid logo" src="../assets/images/cat.jpg" alt="Theme-logo"></a> 
            ...
            <ul class="top-nav">
                ...
                <!-- log out trigger -->
                        <li >
                                ...
                                <a href="Admin/login" data-toggle="modal" data-target="#logoutModal"><i class="icon-logout"></i> LOG <b>OUT</b>
                            </a>
  ...
  <ul class="nav nav-tabs" style="background-color: #f2f2f2"> 
   ...
   <li ><a href="Admin/Cost-Summary">Project</a></li>
      <li><a href="Admin/Cost-Summary">Cost</a></li>
      <li><a href="Admin/Project-Progress">Project Plan</a></li>
      <li ><a href="Admin/Calendar">Calendar</a></li>
      <li ><a href="Admin/Inbox">Inbox</a></li>
      <li class="Admin/active"><a href="Admin/Accounts">Accounts</a></li>
            ...
            <div class="row">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        <li class="breadcrumb-item"><a href="Admin/home"><i class="icon-people"></i></a>
                        </li>
                        <li class="breadcrumb-item">User
                        </li>
                        <li class="breadcrumb-item">Users Table
                        </li>
                        <li class="breadcrumb-item"> <span class="label label-info"><b>User Profile</b>
                            <li class="breadcrumb-item" style="margin-left: 550px"><a href="Admin/Accounts" class="text text-success">  Back to Users Table</a>
                            </li>
                        </li>
                    ...
                    <div class="card faq-left">
                        ...
                        <div class="card-block">
                            ...
                            <div class="faq-profile-btn">
                                ...
                                <a href="#sendMessageModal" data-toggle="modal" title="sendMessage" class="btn btn-success waves-effect waves light" > Message</a>
                           ...
                           <!-- Modal -->
                          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="sendMessageModal" class="modal fade" style="display: none;">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="personal" role="tabpanel">
                            <div class="card">
                                <div class="card-header bg-info"><h5 class="card-header-text">About</h5>
                                                        ...
                                                        <div class="col-lg-12 col-xl-6">
                                                            <table class="table m-0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>Block 32 Lot 5, Palmera Homes, Dahlia St., San Jose del Monte City</td>
                                                                </tr>
