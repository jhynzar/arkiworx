                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="col-sm-12 card dashboard-product">
                        ...
                        <h2 class="dashboard-total-products">$
                            <span class="counter">30,780</span>
                        </h2>
                                ...
                                <table class="table m-b-0 photo-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Appestia Project
                                                <p>
                                                    <i class="icofont icofont-clock-time"></i>Created 14.9.2016</p>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Contract with belife Company
                                                <p>
                                                    <i class="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                            </td>
                                            <td>
