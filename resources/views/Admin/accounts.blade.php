 ...
 <body class="sidebar-mini fixed">
  ...
  <div class="modal-dialog" role="document">
    ...
    <!-- Navbar-->
            ...
            <a href="home" class="nav-brand"><img class="img-fluid logo" src="../assets/images/cat.jpg" alt="Theme-logo"></a> 
            ...
            <ul class="top-nav">
                ...
                <!-- log out trigger -->
                        <li >
                                ...
                                <a href="#" data-toggle="modal" data-target="#logoutModal"><i class="icon-logout"></i> LOG <b>OUT</b>
                            </a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="Project">
                            <i class="icon-book-open"></i><span> Project</span>
                        </a>                
                    </li>
                    ...
                    <li class="treeview">
                        <a class="waves-effect waves-dark" href="Cost-Summary">
                            <i class="icon-briefcase"></i><span> Cost Summary</span>
                        </a>                
                    </li>
...
<!--tabs-->
  ...
  <ul class="nav nav-tabs" style="background-color: #f2f2f2"> 
   ...
   <li ><a href="Cost-Summary">Project</a></li>
      <li><a href="Cost-Summary">Cost</a></li>
      <li><a href="Project-Progress">Project Plan</a></li>
            ...
            <div class="row" style="margin-top: -10px">
                <div class="col-sm-9 p-0">
                    <div class="main-header" >
                       <h4><i class="icon-people"></i> Account</h4>
    ...
    <label class="text text-muted"> Users</label> 
                ...
                <div class="col-sm-3 pull-right">
                    <br> <br> <button type="button" data-toggle="modal" data-target="#addUser" class="btn btn-success waves-effect waves-light" style="margin-left: 45px; margin-top: 50px"> <i class="icon-user-follow"> </i>Add User</button>
                    </div> 
                                    ...
                                    <table class="table table-hover"  >
                                        ...
                                        @foreach($results as $result)
                                                ...
                                                <tr class="table-warning">
                                                    ...
                                                    <td>{{ $result->stremployeefname }}</td><!-- name-->
                                                    <td>{{ $result->stremployeelname }}</td><!-- lastname-->
  ...
  <div class="modal-dialog" role="document">
   ...
   <div style="font-size: 10px !important;">                            
       <form action="/action_page.php"> <!--add pic-->
  <input type="file" name="pic" accept="image/*"> <br> <br>
        ...
        <form class="form-inline"  action="Add-User"> <!--add user-->
                    ...
                    <div class="card faq-left" >
                        ...
                        <div class="card-block">
                            ...
                            <div class="faq-profile-btn">
                               <p class="text-muted"> Add image</p>
   <div style="font-size: 10px !important;">                            
       <form action="/action_page.php"> <!--update pic-->
  <input type="file" name="pic" accept="image/*"> <br> <br>
           <input type="submit" class="btn btn-info">
           {{ csrf_field() }}
           </form>
        ...
        <form class="form-inline"  action="/action_page.php"> <!--update accounts-->
  <div class="form-group">
    <label for="fname">First Name: </label>
