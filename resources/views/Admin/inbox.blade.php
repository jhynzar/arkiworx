                                          ...
                                          <form role="form" class="form-horizontal">
                                              ...
                                              <div class="form-group" >
                                                  <div class="col-lg-offset-2 col-lg-10" style="margin-left: -10px">
                                                      ...
                                                      <button class="btn btn-success btn-send" type="submit"><i class="icon icon-check"> Send</i></button>
                                                      <button type="button" class="btn btn-warning" data-dismiss="modal" style="margin-left: 430px; margin-top: -60px"><i class="icon icon-close" > </i>Cancel</button>
