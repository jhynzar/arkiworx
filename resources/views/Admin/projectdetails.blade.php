        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main-header">
                    <h4><i class="icon-book-open"></i> Project Details</h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"> <span class="label label-info"><b>Project Details</b>
                        </li>
                            <li class="breadcrumb-item" style="margin-left: 550px"><a href="project" class="text text-success">  Back to Project List</a>
                            </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="personal" role="tabpanel">
                            <div class="card">
                                <div class="card-header"><h5 class="card-header-text">About Project</h5>
                                    <button id="edit-btn" type="button" class="btn btn-primary waves-effect waves-light f-right" >
                                       Edit Project <i  class="icofont icofont-edit"></i>
                                    </button>
                                </div>
                                                                         ...
                                                                         <span class="md-add-on">
                                                                            ...
                                                                            <div class="md-input-wrapper">
                                                                                <select class="md-form-control">
                                                                                    <option ><span class="text text-primary">Client</span></option>
