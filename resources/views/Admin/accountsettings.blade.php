 ...
 <body class="sidebar-mini fixed">
            ...
            <ul class="top-nav">
                ...
                <!-- log out trigger -->
                        <li >
                                ...
                                <a href="Login" data-toggle="modal" data-target="#logoutModal"><i class="icon-logout"></i> LOG <b>OUT</b>
                            </a>
  ...
  <ul class="nav nav-tabs" style="background-color: #f2f2f2"> 
    ...
    <li><a href="Admin/home">Dashboard</a></li>
      ...
      <li><a href="#">Cost</a></li>
      <li><a href="Admin/materials%20pricelist">PriceList</a></li>
            ...
            <div class="row" >
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"> <span class="label label-info"><b>My Account</b>
                        </li>
                ...
                <div class="col-lg-3">
                    <div class="card faq-left">
                        ...
                        <div class="card-block">
                            <h4 class="f-18 f-normal m-b-10 txt-primary">Juliamar Soriano</h4>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="personal" role="tabpanel">
                            <div class="card">
                                <div class="card-header"><h5 class="card-header-text">About</h5>
                                    <button id="edit-btn" type="button" class="btn btn-primary waves-effect waves-light f-right" >
                                       Edit Profile <i  class="icofont icofont-edit"></i>
                                    </button>
                                </div>
