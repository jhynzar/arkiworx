...
(function( $ ){
  $.fn.printPage = function(options) {
    ...
    function printit(){
      ...
      //EDITED BUGFIX ".printPage is not a function"
      ...
      //EDITED BUGFIX ".printPage is not a function" - END
    ...
    var components = {
      ...
      messageBox: function(message){
        return "<div id='printMessageBox' style='\
          ...
          width:310px; height:30%; font-size:16px; padding:10px; color:#222; font-family:helvetica, arial;\
          opacity:0;\
